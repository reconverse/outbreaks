...
test_that("zika_yap_2007_td format is correct", {
  expect_columns_lowercase(zika_yap_2007_td)
  expect_that(zika_yap_2007_td, is_a('data.frame'))
  expect_is(zika_yap_2007_td$date_of_onset, 'Date')
  expect_is(zika_yap_2007_td$incidence, 'numeric')
})

test_that("zika_yap_2007_td data are correct", {
  expect_equal(zika_yap_2007_td %>% dim(), c(29, 2))
  tb_sum <- zika_yap_2007_td %>%
