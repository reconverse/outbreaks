...
#'   \item \code{mers.korea.2015[[1]]}: A dataframe of MERS-CoV cases and their attributes
#'     \itemize{
...
#'     }
#'
#'  \item \code{mers.korea.2015[[2]]}: A dataframe describing the relationship between MERS Co-V cases
#'    \itemize{
