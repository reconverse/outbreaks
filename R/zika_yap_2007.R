...
#' Check \code{\link{zika_yap_2007_td}}.
#'
#' @docType data
#'
#' @format {
...
#'
#' @seealso \code{\link{zika_yap_2007_td}}
#'
...
#' please use instead \code{\link{zika_yap_2007}}.
#'
#' # Licence
